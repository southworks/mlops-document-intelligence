...
class ApprovedSampleExportV1Payload(BaseModel):
    """Payload emitted when approved samples are exported for training."""

    model_config = ConfigDict(extra="forbid", protected_namespaces=())

    event_name: Literal["modeladmin.samples.approved.v1"] = APPROVED_SAMPLE_EXPORT_EVENT
    contract_version: Literal["1.0.0"] = "1.0.0"
    export_id: str
    candidate_id: str
    document_id: str
    ...
    training_target_path: Optional[str] = None
