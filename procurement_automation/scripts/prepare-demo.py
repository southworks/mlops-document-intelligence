...
def reset_databases(dry_run: bool) -> None:
    ...
    modeladmin_cmd = [
        ...
        "-c",
        (
            "import modeladmin_service.database.models; "
...
def verify(modeladmin_endpoint: str, backend_endpoint: str, dry_run: bool) -> None:
    ...
    modeladmin_counts_cmd = [
        ...
        "-c",
        (
            "from modeladmin_service.database.connection import SESSION_LOCAL; "
            "from modeladmin_service.database.models import ReviewCandidateModel, TrainingDatasetModel; "
            "s=SESSION_LOCAL(); "
