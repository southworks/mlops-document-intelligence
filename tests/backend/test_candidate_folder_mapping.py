...
def test_resolve_low_confidence_folder() -> None:
    assert resolve_candidate_destination_folder("low_confidence") == "low_confidence"

def test_resolve_low_field_confidence_folder() -> None:
    assert resolve_candidate_destination_folder("low_field_confidence") == "low_field_confidence"
